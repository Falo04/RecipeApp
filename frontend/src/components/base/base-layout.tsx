...
export function BaseLayout({
    ...
    return (
        <div className="relative isolate flex h-svh w-full flex-col bg-white max-lg:flex-col lg:overflow-hidden lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950">
